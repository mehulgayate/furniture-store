...
<div id="main_container">
    ...
    <div >    
    <h2 style="display: inline-block; float: left;">Products</h2> <a style="display: inline-block; float: right;" href="/admin/add-new-product"><strong>+ Add New Product</strong></a> 
    </div>                
...
<table id="rounded-corner" summary="Blocked Users">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Stock Count</th>            
    ...
    <tbody>
    	...
    	<tr>        	
    		<td scope="col" class="rounded-company"></td>
            <td scope="col" class="rounded">${product.name}</td>
            <td scope="col" class="rounded">${product.stock}</td>            
            <td scope="col" class="rounded">${product.status}</td>            
        </tr>
        </#list>
        ...
        <tfoot>
    	<tr>
        	<td colspan="5" class="rounded-foot-left"><em>Listing All Product Above</em></td>
